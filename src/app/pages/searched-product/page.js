...
export default function searchedProduct() {
    ...
    const selectedProduct = (product) => {
        ...
        router.push('/pages/selected-product');
    }
                        ...
                        <div className="mt-5">
                            ...
                            <div className="flex flex-col gap-1">
                                <div className="flex flex-row border-2 border-[var(--yellow)] rounded-[10px]">
                                    ...
                                    <div className=" border-l-2 border-[var(--yellow)] pr-2 pl-2 w-1/2">
                                        <input className="text-[0.8rem] w-full" type="text" placeholder="MA POSITION" />
                                    </div>
                                </div>
                            </div>
                            <div>
